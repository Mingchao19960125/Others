...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec 30 13:47:49 2019
...
path_save='/home/jmanning/Mingchao/others/'
FVCOM_csv=pd.read_csv('/home/jmanning/Mingchao/others/FVCOM.csv')
vessel_name='Lisa_Ann_III'
#path_save_FVCOM='/home/jmanning/Mingchao/others/FVCOM/'
#FVCOM_csv=pd.read_csv(os.path.join(path_save_FVCOM,vessel_name+'_FVCOM.csv'))
...
def get_FVCOM_url(dtime):
    ...
    #elif dtime>=datetime.datetime(2018,7,1):

...
def main():
    ...
    dictionaryfile=os.path.join(dictionarypath,'dictionary2.json') # dictionary with endtime,doppio,gomofs,fvcom where each model has vesselname,lat,lon,time,temp
    ##############################
...
#    emolt='/home/jmanning/leizhao/programe/aqmain/parameter/telemetry.dat'
    print('get emolt df')
...
#    up.sd2drf(local_dir=pic_path,remote_dir='/lei_aq_main/all_pic',filetype='png',keepfolder=False)   #upload the picture to the studentdrifter

...
def read_emolt_all(path='/home/jmanning/Mingchao/result/emolt_dat_all (another copy).csv',endtime=datetime.now()):
...
def read_emolt(start,end,path='/home/jmanning/Mingchao/result/emolt_dat_all (another copy).csv'):
...
def main():
    #end_time=datetime.now()-timedelta(days=13) #get the time of now
    end_time=datetime.now()
    start_time=end_time-timedelta(days=560) #get the time of start time
